...
# 二级分类
class ProblemClassifyTwo(models.Model):
    name = models.TextField()
    parent = models.ForeignKey(ProblemClassify, on_delete=models.CASCADE, null=True, blank=True)
...
class Problem(models.Model):
    ...
    classify = models.ManyToManyField(ProblemClassifyTwo)
    # classify_two = models.ManyToManyField(ProblemClassifyTwo)
