...
from ..models import ProblemTag, Problem, ProblemRuleType, ProblemClassify
from ..serializers import ProblemSerializer, TagSerializer, ProblemSafeSerializer, ClassifySerializer
...
class ProblemClassifyAPI(APIView):
    def get(self, request):
        classifys = ProblemClassify.objects.all()
        return self.success(ClassifySerializer(classifys, many=True).data)
