...
from ..views.admin import (ContestProblemAPI, ProblemAPI, TestCaseAPI, MakeContestProblemPublicAPIView,
                           CompileSPJAPI, AddContestProblemAPI, ExportProblemAPI, ImportProblemAPI, ClassifyAdminAPI,
                           FPSProblemImport, SubclassAdminAPI)
...
urlpatterns = [
    ...
    url(r"^problem/classify_list/?$", ClassifyAdminAPI.as_view(), name="problem_classify_admin_api"),
    url(r"^problem/subclass/?$", SubclassAdminAPI.as_view(), name="subclass_admin_api"),
